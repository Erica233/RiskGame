        ...
        Thread server3 = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    ArrayList<Action> attacks = new ArrayList<>();
...
//                        moves = (ArrayList<Action>) in.readObject();
//                        attacks = (ArrayList<Action>) in.readObject();
...
//                    }
    ...
    void test_serverInThread() throws Exception {
        ...
        BufferedReader mockInput1 = Mockito.mock(BufferedReader.class);
        when(mockInput1.readLine()).thenReturn("M", "a", "c", "1", "D");
        client.setInputReader(mockInput1);
        client.playGame();
        client.closePipes();
